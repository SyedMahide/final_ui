import 'package:final_ui/ui/password_reason.dart';
import 'package:flutter/material.dart';

class PhoneNumberAndEmail extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _PhoneNumberAndEmailState();
  }
}

class _PhoneNumberAndEmailState extends State<PhoneNumberAndEmail> {
  @override
                ...
                child: Container(
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => PasswordAndReason()),
                      );
                    },
