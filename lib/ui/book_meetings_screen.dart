import 'package:final_ui/ui/meeting_place_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';

class BookingMeetings extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _BookingMeetingsState();
  }
}

class _BookingMeetingsState extends State<BookingMeetings> {
  @override
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      height: 160,
                      child: Image(
                        image: AssetImage("assets/meetings.png"),
                      ),
                    ),
                  ),
                ],
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Container(
                        height: 40,
                        child: const Image(
                          image: AssetImage("assets/arcticons_lounge.png"),
                        ),
                      ),
                    ),
                    Expanded(
