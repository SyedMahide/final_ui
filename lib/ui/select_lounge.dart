...
import 'confirm_event_info.dart';

class SelectLounge extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _SelectLoungeState();
  }
}

class _SelectLoungeState extends State<SelectLounge> {
  @override
                ...
                child: Container(
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ConfirmEventInfo()),
                      );
                    },
